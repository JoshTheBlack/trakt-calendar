...
- It no longer builds a month the calendar hasn't reached out of the current one's contents, nor quietly closes off the months in between.
- It now asks which month you want rather than taking whichever one you arrived from, and gathers nothing until you've said — every way in asks, the page you came from included. The ones it already holds are marked as such.
- A month that hasn't begun waits to be asked. It opens empty, saying so, until you tell it to gather — and what it then takes is only what begins in that month, with nothing carried over from the months before it. The month under way still fills itself in the moment you open it.
- A month is now only ever about itself: what begins in it, what you got to the end of in it, what you gave up on in it, and the films you saw in it. What you're still in the middle of is about you rather than about any one month, so it's read from everything you hold at once and shown on the month you're in. Nothing is handed from one month to the next any more, which is what stops a thing that started in June turning up announced as new in August, and stops a month you set up early opening half-empty.
- A thing you finished that has since grown — more of it exists than there was when you got to the end — comes back on its own, marked so you can see it's back rather than wondering what went wrong. The month you finished it in still says you finished it, because you did.
- Turning something away now means what it meant when you did it. Turn it away before a month starts and that month never lists it at all; turn it away once the month is under way and the month records that you'd been following it and stopped. A month already settled is never rewritten by something you say today. Giving up on a thing, or removing it outright, works wherever it's shown from.
- A month settles when the calendar leaves it behind, not when you get round to opening the one after it. Leave it alone for three weeks and last month is no longer sitting there still editable — it's over the day it's over, and what it settled is written down the next time you look at it.
- Any month still ahead can be asked for, however far ahead it is, and they don't have to be done in order — set up December in August and September, October and November are all still there to set up afterwards. Every month of every year is somewhere you can go now; none of them is greyed out. What a month takes when you ask for it is only what's already known about that month, so a distant one simply arrives with little in it. Months already behind you that were never kept are the one thing still refused, since filling those in from what you'd already seen is a separate thing it can do.
- Giving something up now turns it away on the calendar as well, and taking that back brings it straight back — for the things the calendar put on the month to begin with. Anything you added yourself is left alone either way, and a month that has already settled leaves the calendar untouched. Taking a giving-up back never used to hold: open the month again and it had been given up on a second time, with nothing to say why.
