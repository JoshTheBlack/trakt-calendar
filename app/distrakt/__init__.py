...
__all__ = [
    ...
    "Bucket", "ID_COLUMNS", "IDENTITY_COLUMNS", "MonthStanding", "SHOW_COLUMNS",
    "TOTALS_STALE_HOURS", "WATCHED_RECENCY_DAYS",
    "RestoreError", "UnkeyableRecord",
    "add_show", "can_initialize", "completed_seasons", "compute_live_shows",
    "drop_seasons_finished_earlier", "ensure_month", "export_user_data",
    "find_user_row", "freeze_eligible",
    ...
    "record_key",
    "register_networks", "remove_show", "remove_show_everywhere",
    "restore_user_data", "row_to_show",
    "save_month", "set_abandoned", "set_emoji_prefs", "set_month_movies",
    "stamp_refreshed", "user_roster",
]
